...
// Map ST Delay function to FreeRTOS vTaskDelay function.
#define Delay(t) vTaskDelay( ((t)*10) / portTICK_RATE_MS );
...
static  __IO u16 TextColor = 0x0000, BackColor = 0xFFFF;
...
void LCD_WriteBMP(u32 BmpAddress)
{
  ...
  /* Read bitmap size */
  size = *(__IO u16 *) (BmpAddress + 2);
  size |= (*(__IO u16 *) (BmpAddress + 4)) << 16;

  /* Get bitmap data address offset */
  index = *(__IO u16 *) (BmpAddress + 10);
  index |= (*(__IO u16 *) (BmpAddress + 12)) << 16;
  ...
  {
    LCD_WriteRAM(*(__IO u16 *)BmpAddress);
    BmpAddress += 2;
  }
